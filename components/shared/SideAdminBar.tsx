...
import { BookOpen, Calendar, CreditCard, FileText, GraduationCap, LayoutDashboard, Trophy, Users } from "lucide-react";
...
const sideBarItems: SideBarItem[] = [
    { name: "DashBoard", route: "/admin/dashboard", icon: <LayoutDashboard size={16} /> },
    { name: "Student", route: "/admin/students", icon: <Users size={16} /> },
    { name: "Program", route: "/admin/programs", icon: <GraduationCap size={16} /> },
    { name: "Semester", route: "/admin/semesters", icon: <Calendar size={16} /> },
    { name: "Course", route: "/admin/courses", icon: <BookOpen size={16} /> },
    { name: "Application", route: "/admin/applications", icon: <FileText size={16} /> },
    ...
    return (
        <div className="bg-neutral-light shadow-neutral sticky top-0 z-10 h-screen w-64 space-y-4 p-4 shadow-md">
            <div className="flex items-center justify-between">
                <Link href="/admin/dashboard" className="text-primary h-16 text-2xl font-bold">
