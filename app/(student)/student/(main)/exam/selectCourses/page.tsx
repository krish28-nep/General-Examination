        ...
        <div className="space-y-8">
                            ...
                            {semesterData && semesterData.courses &&
                                semesterData.courses.map((course, index) => (
                                    <tr key={`course - ${index}`}>
                                        ...
                                        <td onClick={() => toggleCourseSelection(course.id)} className="border-neutral border-b px-2 py-1 cursor-pointer">
            ...
            <div className='w-[1000px] flex justify-end'>
                <Button
                    ...
                    onClick={() =>
                        router.push(`/student/exam/makePayment?semester=${id}&examType=${examType}&courses=${selectedCourseIds.join(',')}`)
                    }
                    text='Next'
                />
