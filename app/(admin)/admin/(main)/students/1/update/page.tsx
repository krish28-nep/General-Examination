...
const EditStudentPage = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: UserUpdateInput) =>
      updateStudentProfile(Number(userId), data),
    onSuccess: () => {
        ...
        <div className="p-6 flex flex-col gap-4 border border-neutral-300 rounded-2xl shadow-md bg-neutral-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="label-input-group group">
              ...
              />
              {errors.studentProfile?.fatherName && (
            ...
            <div className="label-input-group group">
              ...
              />
              {errors.studentProfile?.motherName && (
                <p className="error-text">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="label-input-group group">
              ...
              <ReusableDropdown
                ...
                placeholder={
                  user?.studentProfile?.maritalStatus || "Select Status"
                }
                onSelect={(item) =>
                  setValue("studentProfile.maritalStatus", item)
                }
              />
              {errors.studentProfile?.maritalStatus && (
                <p className="error-text">
            ...
            <div className="label-input-group group">
              ...
              <input
                ...
                className="input-field"
              />
              {errors.studentProfile?.dateOfBirth && (
                <p className="error-text">
          ...
          <div className="label-input-group group">
            ...
            />
            {errors.studentProfile?.collegeName && (
              <p className="error-text">
          ...
          <div className="label-input-group group">
            ...
            />
            {errors.studentProfile?.collegeAddress && (
              <p className="error-text">
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <ReusableDropdown
                ...
                placeholder={
                  user?.studentProfile?.programId
                    ? String(user.studentProfile.programId)
                    : "Select Program"
                }
                onSelect={(item) =>
            ...
            <div className="label-input-group group">
              ...
              <ReusableDropdown
                ...
                placeholder={
                  user?.studentProfile?.semesterId
                    ? String(user.studentProfile.semesterId)
                    : "Select Semester"
                }
                onSelect={(item) =>
